		...
		<div class="col-md-12">
			<div class="p-3">
				<div class="card bg-light">
					<div class="card-header">Add Global Section</div>
					<div class="card-body">

						<?php echo form_open("cms/globalsection/add"); ?>
						...
						<div class="tab-content">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input name="section_name" type="text" class="form-control <?php echo (form_error('section_name')) ? "is-invalid" : ""; ?>" id="section_name" value="<?php echo set_value('section_name') ?>" placeholder="Enter Name"/>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											...
											<input name="section_alias" type="text" class="form-control <?php echo (form_error('section_alias')) ? "is-invalid" : ""; ?>" id="section_alias" value="<?php echo set_value('section_alias') ?>" placeholder="Enter Alias"/>
							...
							<div role="tabpanel" class="tab-pane" id="images">
								...
								<div class="form-group">
									...
									<?php echo $this->filemanager->render('section_background'); ?>
								</div>
								<div class="form-group">
									<label for="section_img_medium">Tablet Background </label>
									<?php echo $this->filemanager->render('section_img_medium'); ?>
								</div>
								<div class="form-group">
									<label for="section_img_small">Mobile Background </label>
									<?php echo $this->filemanager->render('section_img_small'); ?>
								</div>
							</div>
							<div role="tabpanel" class="tab-pane" id="template">
								...
								<div class="form-group">
									...
									<textarea class="form-control <?php echo (form_error('section_template')) ? "is-invalid" : ""; ?> codeMirror" name="section_template" id="section_template" rows="7" ><?php echo set_value('section_template'); ?></textarea>
									<?php echo form_error('section_template'); ?>
								</div>
								<div class="form-group">
									<label for="section_block_template" class="control-label" >Block Template</label>
									<textarea class="form-control <?php echo (form_error('section_block_template')) ? "is-invalid" : ""; ?> codeMirror" rows="5" name="section_block_template" id="section_block_template"><?php echo set_value('section_block_template'); ?></textarea>
							...
							<div role="tabpanel" class="tab-pane" id="misc-tab">
								...
								<div class="form-group">
									...
									<?php echo $this->filemanager->render('section_icon'); ?>
								</div>
								<?php if (false) { ?>
									<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea name="section_desc" class="form-control mceSimple1 <?php echo (form_error('section_desc')) ? "is-invalid" : ""; ?>" id="section_desc"><?php echo set_value('section_desc') ?></textarea>							
