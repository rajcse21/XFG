						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="images">
								...
								<div class="form-group">
									...
									<?php echo $this->filemanager->render('block_image_small', $block['block)_image_small']); ?>
								</div>
							</div>
							...
							<div role="tabpanel" class="tab-pane" id="misc-tab">
								...
								<div class="form-group">
									...
									<textarea name="block_desc" class="form-control mceSimple1 <?php echo (form_error('block_desc')) ? "is-invalid" : ""; ?>" id="block_desc"><?php echo set_value('block_desc', $block['block_template']) ?></textarea>							
