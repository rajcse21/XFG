<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="cms/globalblock/index/<?php echo $section['global_section_id']; ?>">Global Blocks</a></li>
		...
		<div class="col-md-12">
			<div class="p-3">
				<div class="card bg-light">
					...
					<div class="card-body">
						<?php echo form_open("cms/globalblock/add/{$section['global_section_id']}"); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="form-group">									
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="allow_duplicate1" name="allow_duplicate" value="1" checked class="custom-control-input">
												<label class="custom-control-label" for="allow_duplicate1">Yes</label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="allow_duplicate0" name="allow_duplicate" value="0" class="custom-control-input">
