                ...
                <div class="card bg-light">
                    ...
                    <div class="card-body">						
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="#tab_page_detail" aria-controls=tab_"page_detail" role="tab" data-toggle="tab">Page Detail</a>
                            </li>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class = "form-group">
                                            ...
                                            <textarea class = "form-control <?php echo (form_error('page_content')) ? "is-invalid" : ""; ?>" rows = "5" name = "page_content" id = "page_content"><?php echo set_value('page_content'); ?></textarea>
