            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="nav-link" href="#tabs-<?php echo $total_groups + 1; ?>" role="tab" aria-controls="CSS" data-toggle="tab">CSS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#tabs-<?php echo $total_groups + 2; ?>" role="tab" aria-controls="JS" data-toggle="tab">JS</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        ?>
                        <div role="tabpanel" class="tab-pane" id="tabs-<?php echo $total_groups + 1; ?>">
                            <br/>
                            <div class="form-group">
                                <label for="css_content" class="control-label">CSS (layout.css)<span class="required">*</span></label>
                                <textarea class="form-control <?php echo (form_error('css_content')) ? "is-invalid" : ""; ?> codeMirror" rows="5" name="css_content" id="css_content"><?php echo set_value('css_content', $css_content); ?></textarea>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="tabs-<?php echo $total_groups + 2; ?>">
                            <br/>
                            <div class="form-group">
                                <label for="js_content" class="control-label">JS (global.js)<span class="required">*</span></label>
                                <textarea class="form-control <?php echo (form_error('js_content')) ? "is-invalid" : ""; ?> codeMirror" rows="5" name="js_content" id="js_content"><?php echo set_value('js_content', $js_content); ?></textarea>
                            </div>
                        </div>
