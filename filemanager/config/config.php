...
if (!isset($_COOKIE['xpertfingroup_admin'])) {
    die("Session expired. Please login again");
}

$sess_id = $_COOKIE['xpertfingroup_admin'];

$mysqli = new mysqli("localhost", "xpxp1722_xpertfingroup", 'dTptr&n?51oU', 'xpxp1722_xpertfingroup');
$stmt = $mysqli->prepare("SELECT data FROM xf_session WHERE id = ?");
...
if (strpos($data, 'ADMIN_USER_ID') === FALSE) {
    //die("Session expired. Please login again");
}
...
$config = array(
    ...
    'base_url' => 'https://www.xpertfinancegroup.com.au/',
    /*
      |--------------------------------------------------------------------------
